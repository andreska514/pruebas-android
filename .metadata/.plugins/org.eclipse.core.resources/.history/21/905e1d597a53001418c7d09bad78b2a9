...
public class Segunda extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(clickBoton);
		btnset.setOnClickListener(clickBoton);
	...
	class SaveImageAsynk extends AsyncTask<String, String, String>{
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog = new ProgressDialog(Segunda.this);
	...
	private void initialize() {
		...
		//mPaintBaseLayout.addView(mPaintView, params)
		...
		bm = BitmapFactory.decodeResource(getResources(), R.drawable.sol);

		mPaintView.setImageBitmap(bm);
		View.OnTouchListener paint = (new View.OnTouchListener() {
		...
		mPaintView.setOnTouchListener(paint);
	}
